...
/**
 * Compiles the template into a nodejs factory, adds its to the compilation.src
...
module.exports.compileTemplate = function compileTemplate (template, context, outputFilename, compilation) {
  ...
  var srcBeforeCompilation = _.assign({}, compilation.src[outputOptions.filename]);
  ...
  return new Promise(function (resolve, reject) {
    childCompiler.runAsChild(function (err, entries, childCompilation) {
      ...
      if (childCompilation && childCompilation.errors && childCompilation.errors.length) {
        ...
        compilation.src[outputName] = srcBeforeCompilation[outputName];
        if (srcBeforeCompilation[outputName] === undefined) {
          // If it wasn't there - delete it
          delete compilation.src[outputName];
        }
        resolve({
          ...
          // Compiled code
          content: childCompilation.src[outputName].source()
        });
      }
    });
  });
