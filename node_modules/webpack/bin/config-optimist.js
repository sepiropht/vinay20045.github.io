module.exports = function(optimist) {
	optimist
		...
		.string("output-path").describe("output-path", "The output path for compilation src")
		...
		.string("output-public-path").describe("output-public-path", "The public path for the src")
