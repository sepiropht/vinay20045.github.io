...
yargs.options({
	...
	"sort-src-by": {
		type: "string",
		group: DISPLAY_GROUP,
		describe: "Sorts the src list by property in asset"
	},
	"hide-modules": {
		type: "boolean",
		group: DISPLAY_GROUP,
	...
	"display-cached-src": {
		type: "boolean",
		group: DISPLAY_GROUP,
		describe: "Display also cached src in the output"
	},
	"display-reasons": {
		type: "boolean",
		group: DISPLAY_GROUP,
...
function processOptions(options) {
	...
	ifArg("sort-src-by", function(value) {
		outputOptions.srcSort = value;
	});
	...
	if(!outputOptions.json) {
		...
		if(typeof outputOptions.cachedsrc === "undefined")
			outputOptions.cachedsrc = false;
		...
		ifArg("display-cached-src", function(bool) {
			if(bool)
				outputOptions.cachedsrc = true;
		});
