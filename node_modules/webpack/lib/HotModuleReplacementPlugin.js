...
HotModuleReplacementPlugin.prototype.apply = function(compiler) {
	...
	compiler.plugin("compilation", function(compilation, params) {
		...
		compilation.plugin("should-generate-chunk-src", function() {
		...
		compilation.plugin("additional-chunk-src", function() {
			var records = this.records;
			if(records.hash === this.hash) return;
			...
			Object.keys(records.chunkHashs).forEach(function(chunkId) {
				...
				if(currentChunk) {
					...
					if(newModules.length > 0 || removedModules.length > 0) {
						...
						this.additionalChunksrc.push(filename);
						this.src[filename] = source;
