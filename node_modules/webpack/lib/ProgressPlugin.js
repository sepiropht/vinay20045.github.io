		...
		if(compiler.compilers) {
			...
			compiler.plugin("compilation", function(compilation) {
				...
				const syncHooks = {
					...
					"before-module-src": [0.87, "module src processing"],
					"before-chunk-src": [0.88, "chunk src processing"],
					"additional-chunk-src": [0.89, "additional chunk src processing"],
				...
				compilation.plugin("additional-src", callback => {
				...
				compilation.plugin("optimize-src", (src, callback) => {
